...
import {CustomPopin} from "react-custom-popin-v2/dist/index";
...
const CreateEmployee = () => {
    ...
    return (
        <form onSubmit={handleSaveEmployee} id="create-employee" className="w-full px-6 mb-6 sm:flex sm:flex-col sm:items-center sm:justify-center sm:max-w-[800px]">
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="first-name">First Name</label>
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="last-name">Last Name</label>
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="date-of-birth">Date of Birth</label>
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="start-date">Start Date</label>
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="street">Street</label>
                <input className="max-w-[600px] w-full h-10 rounded-button border-[#EBEBEB] border-[1px] border-solid pl-2 text-xs text-gray placeholder:text-[#ADADAD] focus:outline-none"
                       id="street"
                       type="text"
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="city">City</label>
                <input className="max-w-[600px] w-full h-10 rounded-button border-[#EBEBEB] border-[1px] border-solid pl-2 text-xs text-gray placeholder:text-[#ADADAD] focus:outline-none"
                       id="city"
                       type="text"
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="state">State</label>
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="zip-code">Zip Code</label>
                <input className="max-w-[600px] w-full h-10 rounded-button border-[#EBEBEB] border-[1px] border-solid pl-2 text-xs text-gray placeholder:text-[#ADADAD] focus:outline-none"
                       id="zip-code"
                       type="number"
            ...
            <div className="flex flex-col mb-2 items-center sm:flex-row sm:w-full sm:justify-between">
                <label className="mb-2 !text-black w-full sm:mb-0" htmlFor="department">Department</label>
                <CustomSelect
